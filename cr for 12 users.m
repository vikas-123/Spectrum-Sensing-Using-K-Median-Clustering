...
a=2;
C=2;
Crs=12; %Number of cognitive radio users
PdAnd=0;
...
if (abs(Test(j,sim)-443.964697000000)< abs(Test(j,sim)-474.392432600000))
    detect=detect+1;
end
...
figure(1);
 plot(Pfa,Pmdsim,'r-*');
title('Complementary ROC of Cooperative sensing with K-medians using 12 CRs');
grid on
