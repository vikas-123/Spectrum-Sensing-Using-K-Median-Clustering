...
a=2;
C=2;
Crs=20; %Number of cognitive radio users
PdAnd=0;
max = -10;%to find max in every iteration
...
if (abs(Test(j,sim)-447.792941700000)< abs(Test(j,sim)-470.999655800000))
    detect=detect+1;
end
...
figure(1);
 plot(Pfa,Pmdsim,'r-*');
title('Complementary ROC of Cooperative sensing with K-medians using 20 CRs');
grid on
